...
class Rule
{
    ...
    public:
        /** Default constructor */
        Rule();
        Rule(std::wstring n, bool visible, std::shared_ptr<Expansion> e);
        ...
        void setRuleName(const std::wstring & newName) { name = newName; }
        std::wstring getRuleName() { return name; }
        ...
        /**
          ...
          *
          */
        std::wstring getRuleString() const;
